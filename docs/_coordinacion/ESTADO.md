...
- 2026-06-02 — 🔨 Antigravity: automatización de router seguro de agentes y digest diario mejorado en `feat/agent-router-automation`. Listo para auditoría de Codex.
