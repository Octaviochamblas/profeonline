...
SLUG_TO_FILE = {
    'relacion-entre-mcm-mcd-y-el-producto-de-dos-numeros': 'mat-num-aplicaciones-relacion-producto.yaml',
    'resolucion-de-problemas-de-coincidencia-o-encuentro-con-mcm': 'mat-num-aplicaciones-problema-mcm-coincidencia.yaml',
    'resolucion-de-problemas-de-reparto-en-grupos-iguales-con-mcd': 'mat-num-aplicaciones-problema-mcd-reparto.yaml',
    'decision-de-cuando-usar-mcm-o-mcd-en-un-problema': 'mat-num-aplicaciones-seleccion-mcm-o-mcd.yaml',
}

def update_aplicaciones(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_aplicaciones, reverse_update),
    ]
