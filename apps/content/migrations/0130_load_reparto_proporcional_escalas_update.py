...
SLUG_TO_FILE = {
    'calculo-de-reparto-proporcional-directo': 'calculo-de-reparto-proporcional-directo.yaml',
    'calculo-de-reparto-proporcional-inverso': 'calculo-de-reparto-proporcional-inverso.yaml',
    'calculo-de-una-parte-desconocida-en-reparto-proporcional': 'calculo-de-una-parte-desconocida-en-reparto-proporcional.yaml',
    'interpretacion-de-escala-como-razon': 'interpretacion-de-escala-como-razon.yaml',
    'calculo-de-longitud-en-plano-usando-escala': 'calculo-de-longitud-en-plano-usando-escala.yaml',
    'calculo-de-longitud-real-usando-escala': 'calculo-de-longitud-real-usando-escala.yaml',
    'calculo-de-escala-desconocida': 'calculo-de-escala-desconocida.yaml',
}

def update_reparto_escalas(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_reparto_escalas, reverse_update),
    ]
