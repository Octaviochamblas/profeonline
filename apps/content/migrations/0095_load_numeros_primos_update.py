...
SLUG_TO_FILE = {
    'definicion-de-numero-primo': 'mat-num-numeros-primos-definicion.yaml',
    'identificacion-de-numero-primo-por-cantidad-de-divisores': 'mat-num-numeros-primos-identificacion.yaml',
    'definicion-de-numero-compuesto': 'mat-num-numeros-compuestos-definicion.yaml',
    'identificacion-de-numero-compuesto-por-cantidad-de-divisores': 'mat-num-numeros-compuestos-identificacion.yaml',
    'caso-del-numero-1-frente-a-la-primalidad': 'mat-num-numeros-primos-caso-uno.yaml'
}

def update_numeros_primos(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_numeros_primos, reverse_update),
    ]
