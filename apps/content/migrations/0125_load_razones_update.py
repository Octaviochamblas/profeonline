...
SLUG_TO_FILE = {
    'definicion-de-razon-como-comparacion-por-cociente': 'definicion-de-razon-como-comparacion-por-cociente.yaml',
    'identificacion-del-antecedente': 'identificacion-del-antecedente.yaml',
    'identificacion-del-consecuente': 'identificacion-del-consecuente.yaml',
    'calculo-del-valor-de-la-razon': 'calculo-del-valor-de-la-razon.yaml',
    'concepto-de-serie-de-razones': 'concepto-de-serie-de-razones.yaml',
    'uso-de-la-suma-de-terminos-en-una-serie-de-razones': 'uso-de-la-suma-de-terminos-en-una-serie-de-razones.yaml',
}

def update_razones(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_razones, reverse_update),
    ]
