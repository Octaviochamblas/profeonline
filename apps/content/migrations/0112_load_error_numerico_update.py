...
SLUG_TO_FILE = {
    'calculo-del-error-absoluto': 'mat-num-error-numerico-error-absoluto.yaml',
    'calculo-del-error-relativo': 'mat-num-error-numerico-error-relativo.yaml',
    'calculo-del-error-porcentual': 'mat-num-error-numerico-error-porcentual.yaml',
}

def update_error_numerico(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_error_numerico, reverse_update),
    ]
