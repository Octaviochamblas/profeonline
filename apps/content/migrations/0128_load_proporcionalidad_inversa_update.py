...
SLUG_TO_FILE = {
    'concepto-de-variables-inversamente-proporcionales': 'concepto-de-variables-inversamente-proporcionales.yaml',
    'calculo-de-la-constante-de-proporcionalidad-inversa': 'calculo-de-la-constante-de-proporcionalidad-inversa.yaml',
    'reconocimiento-tabular-de-proporcionalidad-inversa': 'reconocimiento-tabular-de-proporcionalidad-inversa.yaml',
    'representacion-grafica-de-la-proporcion-inversa': 'representacion-grafica-de-la-proporcion-inversa.yaml',
    'modelamiento-algebraico-de-la-proporcion-inversa': 'modelamiento-algebraico-de-la-proporcion-inversa.yaml',
    'resolucion-de-problemas-de-proporcion-inversa': 'resolucion-de-problemas-de-proporcion-inversa.yaml',
}

def update_proporcionalidad_inversa(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_proporcionalidad_inversa, reverse_update),
    ]
