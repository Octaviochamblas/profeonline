...
SLUG_TO_FILE = {
    'definicion-de-expresion-algebraica': 'definicion-de-expresion-algebraica.yaml',
    'identificacion-de-monomio': 'identificacion-de-monomio.yaml',
    'identificacion-de-polinomio': 'identificacion-de-polinomio.yaml',
    'identificacion-de-binomio': 'identificacion-de-binomio.yaml',
    'identificacion-de-trinomio': 'identificacion-de-trinomio.yaml',
    'clasificacion-de-expresiones-segun-cantidad-de-terminos': 'clasificacion-de-expresiones-segun-cantidad-de-terminos.yaml',
}

def update_polinomios_basicos(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_polinomios_basicos, reverse_func),
    ]
