...
SLUG_TO_FILE = {
    'definicion-de-algebra': 'definicion-de-algebra.yaml',
    'distincion-entre-algebra-frente-a-aritmetica': 'distincion-entre-algebra-frente-a-aritmetica.yaml',
    'representacion-de-cantidades-mediante-letras': 'representacion-de-cantidades-mediante-letras.yaml',
    'convencion-de-letras-para-cantidades-conocidas-y-desconocidas': 'convencion-de-letras-para-cantidades-conocidas-y-desconocidas.yaml',
    'concepto-de-variable': 'concepto-de-variable.yaml',
    'concepto-de-constante-algebraica': 'concepto-de-constante-algebraica.yaml',
    'interpretacion-de-la-multiplicacion-implicita-en-notacion-algebraica': 'interpretacion-de-la-multiplicacion-implicita-en-notacion-algebraica.yaml',
}

def update_fundamentos_algebra(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_fundamentos_algebra, reverse_func),
    ]
