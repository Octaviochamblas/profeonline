...
SLUG_TO_FILE = {
    'multiplicacion-de-potencias-de-igual-base': 'multiplicacion-de-potencias-de-igual-base.yaml',
    'division-de-potencias-de-igual-base': 'division-de-potencias-de-igual-base.yaml',
    'potencia-de-una-potencia': 'potencia-de-una-potencia.yaml',
    'potencia-de-un-producto': 'potencia-de-un-producto.yaml',
    'potencia-de-un-cociente': 'potencia-de-un-cociente.yaml',
    'multiplicacion-de-potencias-de-igual-exponente': 'multiplicacion-de-potencias-de-igual-exponente.yaml',
    'division-de-potencias-de-igual-exponente': 'division-de-potencias-de-igual-exponente.yaml',
}

def update_propiedades_potencias(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_propiedades_potencias, reverse_update),
    ]
