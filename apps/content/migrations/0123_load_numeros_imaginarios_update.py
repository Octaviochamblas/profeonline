...
SLUG_TO_FILE = {
    'concepto-de-unidad-imaginaria': 'concepto-de-unidad-imaginaria.yaml',
    'propiedad-i-al-cuadrado-igual-a-menos-uno': 'propiedad-i-al-cuadrado-igual-a-menos-uno.yaml',
    'interpretacion-de-i-como-raiz-de-menos-uno': 'interpretacion-de-i-como-raiz-de-menos-uno.yaml',
    'ciclo-de-potencias-de-la-unidad-imaginaria': 'ciclo-de-potencias-de-la-unidad-imaginaria.yaml',
}

def update_numeros_imaginarios(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_numeros_imaginarios, reverse_update),
    ]
