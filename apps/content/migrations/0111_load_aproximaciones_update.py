...
SLUG_TO_FILE = {
    'aproximacion-por-defecto': 'mat-num-aproximaciones-aproximacion-defecto.yaml',
    'aproximacion-por-exceso': 'mat-num-aproximaciones-aproximacion-exceso.yaml',
    'aproximacion-por-redondeo': 'mat-num-aproximaciones-redondeo.yaml',
    'regla-del-cinco-en-el-redondeo': 'mat-num-aproximaciones-regla-del-cinco.yaml',
    'aproximacion-por-truncamiento': 'mat-num-aproximaciones-truncamiento.yaml',
}

def update_aproximaciones(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_aproximaciones, reverse_update),
    ]
