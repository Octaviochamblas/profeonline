...
SLUG_TO_FILE = {
    'concepto-de-minimo-comun-multiplo': 'mat-num-mcm-concepto.yaml',
    'identificacion-del-mcm-mediante-lista-de-multiplos-comunes': 'mat-num-mcm-identificacion-lista.yaml',
    'calculo-del-mcm-mediante-tabla-de-descomposicion-simultanea': 'mat-num-mcm-metodo-tabla-simultanea.yaml',
    'calculo-del-mcm-mediante-potencias-primas-de-mayor-exponente': 'mat-num-mcm-metodo-potencias-primas.yaml'
}

def update_mcm(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_mcm, reverse_update),
    ]
