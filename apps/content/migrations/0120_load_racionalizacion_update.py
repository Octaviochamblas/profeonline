...
SLUG_TO_FILE = {
    'racionalizacion-con-denominador-monomio-de-raiz-cuadrada': 'racionalizacion-con-denominador-monomio-de-raiz-cuadrada.yaml',
    'racionalizacion-con-denominador-monomio-de-raiz-enesima': 'racionalizacion-con-denominador-monomio-de-raiz-enesima.yaml',
    'racionalizacion-con-denominador-binomio-mediante-conjugado': 'racionalizacion-con-denominador-binomio-mediante-conjugado.yaml',
}

def update_racionalizacion(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_racionalizacion, reverse_update),
    ]
