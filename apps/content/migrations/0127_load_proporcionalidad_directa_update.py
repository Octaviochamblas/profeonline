...
SLUG_TO_FILE = {
    'concepto-de-variables-directamente-proporcionales': 'concepto-de-variables-directamente-proporcionales.yaml',
    'calculo-de-la-constante-de-proporcionalidad-directa': 'calculo-de-la-constante-de-proporcionalidad-directa.yaml',
    'reconocimiento-tabular-de-proporcionalidad-directa': 'reconocimiento-tabular-de-proporcionalidad-directa.yaml',
    'representacion-grafica-de-la-proporcion-directa': 'representacion-grafica-de-la-proporcion-directa.yaml',
    'modelamiento-algebraico-de-la-proporcion-directa': 'modelamiento-algebraico-de-la-proporcion-directa.yaml',
    'resolucion-de-problemas-de-proporcion-directa': 'resolucion-de-problemas-de-proporcion-directa.yaml',
}

def update_proporcionalidad_directa(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_proporcionalidad_directa, reverse_update),
    ]
