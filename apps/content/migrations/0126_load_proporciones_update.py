...
SLUG_TO_FILE = {
    'definicion-de-proporcion-como-igualdad-de-razones': 'definicion-de-proporcion-como-igualdad-de-razones.yaml',
    'identificacion-de-terminos-extremos': 'identificacion-de-terminos-extremos.yaml',
    'identificacion-de-terminos-medios': 'identificacion-de-terminos-medios.yaml',
    'aplicacion-del-producto-cruzado-en-una-proporcion': 'aplicacion-del-producto-cruzado-en-una-proporcion.yaml',
    'calculo-de-la-cuarta-proporcional': 'calculo-de-la-cuarta-proporcional.yaml',
    'calculo-de-la-media-proporcional': 'calculo-de-la-media-proporcional.yaml',
    'calculo-de-la-tercera-proporcional': 'calculo-de-la-tercera-proporcional.yaml',
    'uso-de-la-composicion-proporcional': 'uso-de-la-composicion-proporcional.yaml',
    'uso-de-la-descomposicion-proporcional': 'uso-de-la-descomposicion-proporcional.yaml',
}

def update_proporciones(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_proporciones, reverse_update),
    ]
