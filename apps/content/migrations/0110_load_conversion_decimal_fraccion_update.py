...
SLUG_TO_FILE = {
    'conversion-de-decimal-finito-a-fraccion': 'mat-num-decimal-fraccion-finito.yaml',
    'conversion-de-decimal-periodico-a-fraccion': 'mat-num-decimal-fraccion-periodico.yaml',
    'conversion-de-decimal-semiperiodico-a-fraccion': 'mat-num-decimal-fraccion-semiperiodico.yaml',
}

def update_conversion_decimal_fraccion(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_conversion_decimal_fraccion, reverse_update),
    ]
