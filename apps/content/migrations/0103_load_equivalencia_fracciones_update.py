...
SLUG_TO_FILE = {
    'concepto-de-fracciones-equivalentes': 'mat-num-fracciones-equivalencia-fracciones-equivalentes-concepto.yaml',
    'amplificacion-de-fracciones': 'mat-num-fracciones-equivalencia-amplificacion.yaml',
    'simplificacion-de-fracciones': 'mat-num-fracciones-equivalencia-simplificacion.yaml',
    'identificacion-de-fraccion-irreductible': 'mat-num-fracciones-equivalencia-fraccion-irreductible.yaml',
    'verificacion-de-fracciones-equivalentes-mediante-productos-cruzados': 'mat-num-fracciones-equivalencia-productos-cruzados.yaml',
    'conversion-de-numero-mixto-a-fraccion-impropia': 'mat-num-fracciones-equivalencia-mixto-a-impropia.yaml',
    'conversion-de-fraccion-impropia-a-numero-mixto': 'mat-num-fracciones-equivalencia-impropia-a-mixto.yaml',
}

def update_equivalencia_fracciones(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_equivalencia_fracciones, reverse_update),
    ]
