...
SLUG_TO_FILE = {
    'concepto-de-proporcionalidad-compuesta': 'concepto-de-proporcionalidad-compuesta.yaml',
    'identificacion-de-una-relacion-directa-en-contexto-compuesto': 'identificacion-de-una-relacion-directa-en-contexto-compuesto.yaml',
    'identificacion-de-una-relacion-inversa-en-contexto-compuesto': 'identificacion-de-una-relacion-inversa-en-contexto-compuesto.yaml',
    'resolucion-manteniendo-una-variable-constante': 'resolucion-manteniendo-una-variable-constante.yaml',
    'uso-de-la-formula-generalizada-de-proporcion-compuesta': 'uso-de-la-formula-generalizada-de-proporcion-compuesta.yaml',
    'resolucion-de-problemas-de-proporcionalidad-compuesta': 'resolucion-de-problemas-de-proporcionalidad-compuesta.yaml',
}

def update_proporcionalidad_compuesta(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_proporcionalidad_compuesta, reverse_update),
    ]
