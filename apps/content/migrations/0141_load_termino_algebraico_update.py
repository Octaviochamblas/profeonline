...
SLUG_TO_FILE = {
    'definicion-de-termino-algebraico': 'definicion-de-termino-algebraico.yaml',
    'identificacion-del-signo-de-un-termino': 'identificacion-del-signo-de-un-termino.yaml',
    'identificacion-del-coeficiente-numerico': 'identificacion-del-coeficiente-numerico.yaml',
    'identificacion-de-la-parte-literal': 'identificacion-de-la-parte-literal.yaml',
    'identificacion-del-exponente-de-una-letra-en-un-termino': 'identificacion-del-exponente-de-una-letra-en-un-termino.yaml',
    'calculo-del-grado-absoluto-de-un-termino': 'calculo-del-grado-absoluto-de-un-termino.yaml',
    'calculo-del-grado-relativo-de-un-termino': 'calculo-del-grado-relativo-de-un-termino.yaml',
}

def update_termino_algebraico(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_termino_algebraico, reverse_func),
    ]
