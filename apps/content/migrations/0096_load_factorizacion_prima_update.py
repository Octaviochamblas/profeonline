...
SLUG_TO_FILE = {
    'concepto-de-factor-primo': 'mat-num-factorizacion-prima-factor-concepto.yaml',
    'descomposicion-prima-como-producto-de-factores-primos': 'mat-num-factorizacion-prima-descomposicion-concepto.yaml',
    'unicidad-de-la-descomposicion-prima': 'mat-num-factorizacion-prima-descomposicion-unica.yaml',
    'factorizacion-prima-mediante-tabla': 'mat-num-factorizacion-prima-metodo-tabla.yaml',
    'factorizacion-prima-mediante-arbol-de-factores': 'mat-num-factorizacion-prima-metodo-arbol.yaml',
    'calculo-de-cantidad-total-de-divisores-mediante-exponentes': 'mat-num-factorizacion-cantidad-divisores.yaml'
}

def update_factorizacion_prima(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_factorizacion_prima, reverse_update),
    ]
