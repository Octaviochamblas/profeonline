...
SLUG_TO_FILE = {
    'definicion-de-serie-como-suma-de-terminos-de-una-sucesion': 'definicion-de-serie-como-suma-de-terminos-de-una-sucesion.yaml',
    'calculo-de-una-serie-geometrica-finita': 'calculo-de-una-serie-geometrica-finita.yaml',
    'concepto-de-serie-geometrica-infinita': 'concepto-de-serie-geometrica-infinita.yaml',
    'condicion-de-convergencia-de-una-serie-geometrica-infinita-segun-el-valor-absoluto-de-la-razon': 'condicion-de-convergencia-de-una-serie-geometrica-infinita-segun-el-valor-absoluto-de-la-razon.yaml',
    'calculo-de-la-suma-de-una-serie-geometrica-infinita-convergente': 'calculo-de-la-suma-de-una-serie-geometrica-infinita-convergente.yaml',
    'interpretacion-de-la-suma-infinita-como-valor-limite': 'interpretacion-de-la-suma-infinita-como-valor-limite.yaml',
}

def update_serie_geometrica(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_serie_geometrica, reverse_func),
    ]
