...
SLUG_TO_FILE = {
    'concepto-de-notacion-cientifica': 'concepto-de-notacion-cientifica.yaml',
    'escritura-de-un-numero-grande-en-notacion-cientifica': 'escritura-de-un-numero-grande-en-notacion-cientifica.yaml',
    'escritura-de-un-numero-pequeno-en-notacion-cientifica': 'escritura-de-un-numero-pequeno-en-notacion-cientifica.yaml',
    'conversion-de-notacion-cientifica-a-numero-decimal': 'conversion-de-notacion-cientifica-a-numero-decimal.yaml',
    'multiplicacion-de-numeros-en-notacion-cientifica': 'multiplicacion-de-numeros-en-notacion-cientifica.yaml',
    'division-de-numeros-en-notacion-cientifica': 'division-de-numeros-en-notacion-cientifica.yaml',
    'adicion-y-sustraccion-en-notacion-cientifica-con-igual-exponente': 'adicion-y-sustraccion-en-notacion-cientifica-con-igual-exponente.yaml',
}

def update_notacion_cientifica(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_notacion_cientifica, reverse_update),
    ]
