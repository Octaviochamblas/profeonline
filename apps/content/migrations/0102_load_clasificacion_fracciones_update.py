...
SLUG_TO_FILE = {
    'identificacion-de-fraccion-propia': 'mat-num-fracciones-clasificacion-fraccion-propia.yaml',
    'identificacion-de-fraccion-impropia': 'mat-num-fracciones-clasificacion-fraccion-impropia.yaml',
    'identificacion-de-fraccion-aparente': 'mat-num-fracciones-clasificacion-fraccion-aparente.yaml',
    'concepto-de-numero-mixto': 'mat-num-fracciones-clasificacion-numero-mixto-concepto.yaml',
    'fraccion-no-definida-con-denominador-cero': 'mat-num-fracciones-clasificacion-fraccion-no-definida.yaml',
    'forma-indeterminada-cero-sobre-cero': 'mat-num-fracciones-clasificacion-forma-indeterminada-cero-sobre-cero.yaml',
}

def update_clasificacion_fracciones(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_clasificacion_fracciones, reverse_update),
    ]
