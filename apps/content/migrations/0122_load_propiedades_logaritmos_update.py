...
SLUG_TO_FILE = {
    'logaritmo-de-un-producto': 'logaritmo-de-un-producto.yaml',
    'logaritmo-de-un-cociente': 'logaritmo-de-un-cociente.yaml',
    'logaritmo-de-una-potencia': 'logaritmo-de-una-potencia.yaml',
    'logaritmo-de-una-raiz': 'logaritmo-de-una-raiz.yaml',
    'cambio-de-base-de-un-logaritmo': 'cambio-de-base-de-un-logaritmo.yaml',
    'potencia-cuya-base-coincide-con-la-base-del-logaritmo': 'potencia-cuya-base-coincide-con-la-base-del-logaritmo.yaml',
    'logaritmo-de-una-potencia-con-igual-base': 'logaritmo-de-una-potencia-con-igual-base.yaml',
}

def update_propiedades_logaritmos(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_propiedades_logaritmos, reverse_update),
    ]
