...
SLUG_TO_FILE = {
    'definicion-de-numero-racional-como-ab-con-b-distinto-de-cero': 'mat-num-racionales-concepto-definicion-q.yaml',
    'condicion-de-denominador-distinto-de-cero': 'mat-num-racionales-concepto-condicion-denominador-no-cero.yaml',
    'representacion-de-numeros-enteros-como-racionales': 'mat-num-racionales-concepto-enteros-como-racionales.yaml',
    'signo-de-un-numero-racional-escrito-como-fraccion': 'mat-num-racionales-concepto-signo-racional.yaml',
}

def update_numeros_racionales(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_numeros_racionales, reverse_update),
    ]
