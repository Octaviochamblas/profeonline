...
SLUG_TO_FILE = {
    'interpretacion-de-fraccion-como-parte-de-un-todo': 'mat-num-fracciones-concepto-fraccion-parte-todo.yaml',
    'identificacion-del-numerador': 'mat-num-fracciones-concepto-numerador-identificacion.yaml',
    'identificacion-del-denominador': 'mat-num-fracciones-concepto-denominador-identificacion.yaml',
    'concepto-de-unidad-fraccionaria': 'mat-num-fracciones-concepto-unidad-fraccionaria.yaml',
}

def update_fracciones(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_fracciones, reverse_update),
    ]
