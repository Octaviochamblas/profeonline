...
SLUG_TO_FILE = {
    'definicion-del-conjunto-de-los-numeros-reales': 'definicion-del-conjunto-de-los-numeros-reales.yaml',
    'construccion-de-los-reales-como-union-de-racionales-e-irracionales': 'construccion-de-los-reales-como-union-de-racionales-e-irracionales.yaml',
    'inclusion-de-conjuntos-numericos-en-los-reales': 'inclusion-de-conjuntos-numericos-en-los-reales.yaml',
    'representacion-de-numeros-reales-en-la-recta-numerica': 'representacion-de-numeros-reales-en-la-recta-numerica.yaml',
    'orden-de-numeros-reales': 'orden-de-numeros-reales.yaml',
    'operatoria-en-el-conjunto-de-los-numeros-reales': 'operatoria-en-el-conjunto-de-los-numeros-reales.yaml',
}

def update_numeros_reales(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_numeros_reales, reverse_update),
    ]
