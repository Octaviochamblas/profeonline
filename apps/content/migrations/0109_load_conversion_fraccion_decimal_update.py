...
SLUG_TO_FILE = {
    'conversion-de-fraccion-a-decimal-mediante-division': 'mat-num-fraccion-decimal-conversion-division.yaml',
    'conversion-de-fraccion-decimal-a-numero-decimal': 'mat-num-fraccion-decimal-denominador-potencia-diez.yaml',
    'deteccion-de-decimal-finito-desde-la-fraccion-irreductible': 'mat-num-fraccion-decimal-deteccion-decimal-finito.yaml',
    'deteccion-de-decimal-periodico-desde-la-fraccion-irreductible': 'mat-num-fraccion-decimal-deteccion-decimal-periodico.yaml',
}

def update_conversion_fraccion_decimal(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_conversion_fraccion_decimal, reverse_update),
    ]
