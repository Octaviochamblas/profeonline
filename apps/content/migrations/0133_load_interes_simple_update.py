...
SLUG_TO_FILE = {
    'concepto-de-interes-simple': 'concepto-de-interes-simple.yaml',
    'calculo-del-interes-simple': 'calculo-del-interes-simple.yaml',
    'calculo-del-monto-final-en-interes-simple': 'calculo-del-monto-final-en-interes-simple.yaml',
    'calculo-del-capital-inicial-en-interes-simple': 'calculo-del-capital-inicial-en-interes-simple.yaml',
    'calculo-de-la-tasa-en-interes-simple': 'calculo-de-la-tasa-en-interes-simple.yaml',
    'calculo-del-tiempo-en-interes-simple': 'calculo-del-tiempo-en-interes-simple.yaml',
}

def update_interes_simple(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_interes_simple, reverse_update),
    ]
